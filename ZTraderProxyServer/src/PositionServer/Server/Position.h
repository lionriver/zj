...
namespace ZTraderProxy
{

    /* callback of async proxy for client */
    class PositionPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~PositionPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __Position_all[]=
            {
                "test"
            };
            auto it = _msg_->response->status.find("TARS_FUNC");
            pair<string*, string*> r = equal_range(__Position_all, __Position_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Position_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<PositionPrxCallback> PositionPrxCallbackPtr;

    //callback of promise async proxy for client
    class PositionPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~PositionPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< PositionPrxCallbackPromise::Promisetest > PromisetestPtr;

        PositionPrxCallbackPromise(const tars::Promise< PositionPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const PositionPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< PositionPrxCallbackPromise::PromisetestPtr > _promise_test;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__Position_all, __Position_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __Position_all)
            {
                case 0:
                {
                    ...
                    PositionPrxCallbackPromise::PromisetestPtr ptr (new PositionPrxCallbackPromise::Promisetest());
    ...
    typedef tars::TC_AutoPtr<PositionPrxCallbackPromise> PositionPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class PositionCoroPrxCallback: public PositionPrxCallback
    {
    public:
        virtual ~PositionCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<PositionCoroPrxCallback> PositionCoroPrxCallbackPtr;

    /* proxy for client */
    class PositionProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(PositionPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
        ...
        tars::Future< PositionPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< PositionPrxCallbackPromise::PromisetestPtr > promise;
            PositionPrxCallbackPromisePtr callback (new PositionPrxCallbackPromise(promise));
        ...
        void coro_test(PositionCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        PositionProxy* tars_hash(size_t key)
        {
            return (PositionProxy*)ServantProxy::tars_hash(key);
        }

        PositionProxy* tars_consistent_hash(size_t key)
        {
            return (PositionProxy*)ServantProxy::tars_consistent_hash(key);
        }

        PositionProxy* tars_open_trace(bool traceParam = false)
        {
            return (PositionProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        PositionProxy* tars_set_timeout(int msecond)
        {
            return (PositionProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "PositionProxy"; }
    };
    typedef tars::TC_AutoPtr<PositionProxy> PositionPrx;

    /* servant for server */
    class Position : public tars::Servant
    {
    public:
        virtual ~Position(){}
    ...
    public:
        ...
        {
            static ::std::string __ZTraderProxy__Position_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__ZTraderProxy__Position_all, __ZTraderProxy__Position_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __ZTraderProxy__Position_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
